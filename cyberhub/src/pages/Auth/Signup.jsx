      ...
      <main style={{
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: '#000' }}>Username*</label>
            ...
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: '#000' }}>Email*</label>
            <div style={{ position: 'relative', marginBottom: '20px' }}>
              <input
                type="email"
                name="email"
            ...
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: '#000' }}>Confirm Password*</label>
          ...
          <p style={{ textAlign: 'center', fontSize: '14px', color: '#000' }}>
            ...
            <Link to="/login" style={{ color: '#5a2dff', fontWeight: '600', textDecoration: 'none' }}>
              Log in
            </Link>
          </p>
        </div>
