    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          backgroundColor: '#1a2147',
          borderRadius: '5px',
          height: 'calc(100vh - 140px)', /* Adjusted to match terminal height accounting for padding */
          overflowY: 'auto',
          position: 'relative'
        }}>
          <h2 style={{ 
...
nslookup cyberhub.com`}
            ...
            <div style={{ marginTop: '10px', color: '#888' }}>
              ...
              <ul style={{ listStyleType: 'none', paddingLeft: '20px' }}>
                <li style={{ marginBottom: '8px' }}><code>cd ~/dns_spoofing</code>: Navigate to the lab directory in your home folder</li>
                ...
                <li style={{ marginBottom: '8px' }}><code>cat /etc/resolv.conf</code>: This command displays the content of the resolv.conf file, which contains the system's DNS configuration including nameserver IP addresses. It helps identify if any unauthorized DNS servers have been added</li>
                <li style={{ marginBottom: '8px' }}><code>nslookup cyberhub.com</code>: A DNS query tool that shows which IP address cyberhub.com resolves to and which DNS server provided the answer. This helps detect if domains are being redirected to malicious IP addresses</li>
              </ul>
              <p>These commands help you identify potential DNS spoofing by examining DNS configurations and testing domain resolution behavior.</p>
            </div>
          </div>
...
grep cyberhub.com /etc/hosts`}
            ...
            <div style={{ marginTop: '10px', color: '#888' }}>
              <p style={{ marginBottom: '10px' }}>Command explanations:</p>
              <ul style={{ listStyleType: 'none', paddingLeft: '20px' }}>
                <li style={{ marginBottom: '8px' }}><code>python3 dnspt2.py</code>: Execute the analysis script that performs deeper investigation of suspicious DNS behavior</li>
                <li style={{ marginBottom: '8px' }}><code>dig @8.8.8.8 cyberhub.com</code>: Use the dig (Domain Information Groper) command to query Google's public DNS server (8.8.8.8) directly. This helps verify if the domain resolves differently on a trusted DNS server, which would indicate DNS spoofing</li>
                <li style={{ marginBottom: '8px' }}><code>grep cyberhub.com /etc/hosts</code>: Search for any entries of cyberhub.com in the hosts file, which is a common target for DNS spoofing attacks where attackers add malicious IP mappings</li>
              </ul>
              <p>These commands help you analyze suspicious DNS resolutions and confirm spoofing by consulting trusted DNS servers.</p>
            </div>
          </div>
...
curl -Is https://cyberhub.com | head -n 1`}
            ...
            <div style={{ marginTop: '10px', color: '#888' }}>
              ...
              <p>These commands help you systematically remove malicious DNS entries, add correct ones, and verify that everything is working properly.</p>
            </div>
          </div>
        </div>
      </div>
