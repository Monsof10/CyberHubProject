...
const learningObjectives = [
  ...
  'Real-world DNS poisoning scenarios',
...
const levelContent = {
  1: {
    title: "Level 1: Introduction to DNS Poisoning",
    overview: "Learn the basics of DNS poisoning attacks and their impact on network security.",
    prerequisites: [
  ...
  2: {
    title: "Level 2: Basic DNS Poisoning Techniques",
    overview: "Explore common DNS poisoning methods and understand their impact.",
    prerequisites: [
  ...
  3: {
    title: "Level 3: Advanced DNS Poisoning Methods",
    overview: "Master complex DNS poisoning techniques and automated tools.",
    prerequisites: [
  ...
  4: {
    ...
    overview: "Learn advanced techniques for detecting and preventing DNS poisoning attacks.",
    prerequisites: [
  ...
  5: {
    ...
    overview: "Implement enterprise-level protection against DNS poisoning attacks.",
    prerequisites: [
...
const DnsPoisoningHome = () => {
  ...
  const calculateProgress = () => {
    if (!progress?.progress?.dnspoisoning) return 0;
    const module = progress.progress.dnspoisoning;
    ...
    if (window.confirm('Are you sure you want to reset your progress? This cannot be undone.')) {
      try {
        const updatedProgress = {
          ...progress.progress,
          dnspoisoning: Object.fromEntries(
            Object.entries(progress.progress.dnspoisoning).map(([key]) => [
              key,
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <h1 style={{
            ...
            DNS Poisoning: Attack & Defense Techniques
          </h1>
          <p style={{
            fontSize: '20px',
            textAlign: 'center',
            ...
            Master DNS poisoning attacks and defenses through practical labs and real-world scenarios.
          </p>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'sticky', top: '20px' }}>
          <div style={{
            ...
            <Link 
              to={user ? "/DnsPoisoning/Article" : "/login"}
...
export default DnsPoisoningHome;
