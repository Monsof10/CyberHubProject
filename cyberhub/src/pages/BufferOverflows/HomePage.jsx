...
const levelContent = {
  1: {
    title: "Level 1: Introduction to Buffer Overflows",
    overview: "Learn the basics of buffer overflow vulnerabilities and their impact on system security.",
    prerequisites: [
  ...
  2: {
    title: "Level 2: Basic Exploitation Techniques",
    overview: "Explore common buffer overflow exploitation methods and understand their impact.",
    prerequisites: [
  ...
  3: {
    title: "Level 3: Advanced Exploitation Methods",
    overview: "Master complex buffer overflow techniques and automated tools.",
    prerequisites: [
  ...
  4: {
    ...
    overview: "Learn advanced techniques for detecting and preventing buffer overflow attacks.",
    prerequisites: [
  ...
  5: {
    ...
    overview: "Implement enterprise-level protection against buffer overflow attacks.",
    prerequisites: [
...
const BufferOverflowsHome = () => {
  ...
  const calculateProgress = () => {
    if (!progress?.progress?.bufferoverflows) return 0;
    const module = progress.progress.bufferoverflows;
    ...
    if (window.confirm('Are you sure you want to reset your progress? This cannot be undone.')) {
      try {
        const updatedProgress = {
          ...progress.progress,
          bufferoverflows: Object.fromEntries(
            Object.entries(progress.progress.bufferoverflows).map(([key]) => [
              key,
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <h1 style={{
            ...
            Buffer Overflows: Exploitation & Defense
          </h1>
          <p style={{
            fontSize: '20px',
            textAlign: 'center',
            ...
            Master buffer overflow vulnerabilities and defenses through practical labs and real-world scenarios.
          </p>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'sticky', top: '20px' }}>
          <div style={{
            ...
            <Link 
              to={user ? "/BufferOverflows/Article" : "/login"}
...
export default BufferOverflowsHome;
