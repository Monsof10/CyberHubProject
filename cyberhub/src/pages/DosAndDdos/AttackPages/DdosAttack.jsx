...
const IcmpFloodAttack = () => {
  ...
  useEffect(() => {
    ...
    if (isUnderAttack) {
      ...
      }, 50); // Update every 50ms for more frequent logs
    }
...
• <span style={{color: '#40E0D0'}}>ddos.py</span> – The Python script being executed which is carrying the ai model that will launch the attack.
          ...
          <p style={{ marginTop: '10px' }}>2. Watch the Monitoring Terminal to see the attack progress and then click on the link again , DON'T refresh the old website because the attack is being fetched , we are using a local storage in the backend to organise events for the website , no need to confuse yourself , just click the link after and before runni ng commands and you will understand </p>
...
export default IcmpFloodAttack;
