      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p>
              The files you ran are premade attack files done to show you how you can mitigate a DDoS attack. Those commands represent real life scenarios. In the next levels you will learn how can you start these attacks by yourself
            </p>
          </div>
          </div>
        </div>
