...
const levelContent = {
  1: {
    title: "Level 1: Introduction to Forensic Science",
    overview: "Learn the fundamentals of digital forensic science and its role in cybersecurity.",
    prerequisites: [
  ...
  2: {
    title: "Level 2: Evidence Collection",
    overview: "Explore methods for collecting and preserving digital evidence securely.",
    prerequisites: [
  ...
  3: {
    title: "Level 3: Forensic Analysis",
    overview: "Master forensic analysis techniques for various digital artifacts.",
    prerequisites: [
  ...
  4: {
    title: "Level 4: Incident Response",
    overview: "Learn procedures for responding to cybersecurity incidents effectively.",
    prerequisites: [
  ...
  5: {
    title: "Level 5: Advanced Forensics",
    overview: "Implement advanced forensic techniques and legal considerations.",
    prerequisites: [
...
const ForensicScienceHome = () => {
  ...
  const calculateProgress = () => {
    if (!progress?.progress?.forensicscience) return 0;
    const module = progress.progress.forensicscience;
    ...
    if (window.confirm('Are you sure you want to reset your progress? This cannot be undone.')) {
      try {
        const updatedProgress = {
          ...progress.progress,
          forensicscience: Object.fromEntries(
            Object.entries(progress.progress.forensicscience).map(([key]) => [
              key,
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <h1 style={{
            ...
            Forensic Science: Digital Investigation Techniques
          </h1>
          <p style={{
            fontSize: '20px',
            textAlign: 'center',
            ...
            Master digital forensic science and investigation methods through practical labs and case studies.
          </p>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'sticky', top: '20px' }}>
          <div style={{
            ...
            <Link 
              to={user ? "/ForensicScience/Article" : "/login"}
...
export default ForensicScienceHome;
