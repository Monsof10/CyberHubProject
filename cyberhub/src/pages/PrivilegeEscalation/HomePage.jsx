...
const levelContent = {
  1: {
    title: "Level 1: Introduction to Privilege Escalation",
    overview: "Learn the basics of privilege escalation attacks and their impact on system security.",
    prerequisites: [
      'Basic understanding of operating systems',
      'Familiarity with user permissions',
      'No prior security knowledge required'
    ]
  },
  2: {
    title: "Level 2: Basic Escalation Techniques",
    overview: "Explore common privilege escalation methods and understand their impact.",
    prerequisites: [
  ...
  3: {
    title: "Level 3: Advanced Escalation Methods",
    overview: "Master complex privilege escalation techniques and automated tools.",
    prerequisites: [
  ...
  4: {
    ...
    overview: "Learn advanced techniques for detecting and preventing privilege escalation attacks.",
    prerequisites: [
  ...
  5: {
    ...
    overview: "Implement enterprise-level protection against privilege escalation attacks.",
    prerequisites: [
...
const PrivilegeEscalationHome = () => {
  ...
  const calculateProgress = () => {
    if (!progress?.progress?.privilegeescalation) return 0;
    const module = progress.progress.privilegeescalation;
    ...
    if (window.confirm('Are you sure you want to reset your progress? This cannot be undone.')) {
      try {
        const updatedProgress = {
          ...progress.progress,
          privilegeescalation: Object.fromEntries(
            Object.entries(progress.progress.privilegeescalation).map(([key]) => [
              key,
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <h1 style={{
            ...
            Privilege Escalation: Attack & Defense Techniques
          </h1>
          <p style={{
            fontSize: '20px',
            textAlign: 'center',
            ...
            Master privilege escalation attacks and defenses through practical labs and real-world scenarios.
          </p>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'sticky', top: '20px' }}>
          <div style={{
            ...
            <Link 
              to={user ? "/PrivilegeEscalation/Article" : "/login"}
...
export default PrivilegeEscalationHome;
