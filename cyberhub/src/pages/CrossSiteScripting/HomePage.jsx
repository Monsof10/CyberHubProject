...
const levelContent = {
  1: {
    title: "Level 1: Introduction to Cross-Site Scripting",
    overview: "Learn the basics of XSS attacks and understand how they exploit web application vulnerabilities.",
    prerequisites: [
  ...
  2: {
    title: "Level 2: Basic XSS Techniques",
    overview: "Explore common XSS attack methods and understand their impact on web security.",
    prerequisites: [
      'Completion of Level 1',
      'Basic JavaScript knowledge',
      'Understanding of web forms and inputs'
    ]
  },
  3: {
    title: "Level 3: Advanced XSS Methods",
    overview: "Master complex XSS techniques and learn about automated attack tools.",
    prerequisites: [
  ...
  4: {
    ...
    overview: "Learn advanced techniques for detecting and preventing XSS attacks.",
    prerequisites: [
      'Completion of Level 3',
      'Advanced web security skills',
      'Security implementation experience'
    ]
  },
  5: {
    title: "Level 5: Enterprise Security",
    overview: "Implement enterprise-level protection against sophisticated XSS attacks.",
    prerequisites: [
      'Completion of Level 4',
      'Expert web security knowledge',
      'Advanced security experience'
    ]
  }
};

const CrossSiteScriptingHome = () => {
  ...
  const calculateProgress = () => {
    if (!progress?.progress?.crosssitescripting) return 0;
    const module = progress.progress.crosssitescripting;
    ...
    if (window.confirm('Are you sure you want to reset your progress? This cannot be undone.')) {
      try {
        const updatedProgress = {
          ...progress.progress,
          crosssitescripting: Object.fromEntries(
            Object.entries(progress.progress.crosssitescripting).map(([key]) => [
              key,
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <h1 style={{
            ...
            Cross-Site Scripting: Advanced Web Security
          </h1>
          <p style={{
            fontSize: '20px',
            textAlign: 'center',
            ...
            Master Cross-Site Scripting techniques and defenses through hands-on labs and real-world scenarios.
          </p>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'sticky', top: '20px' }}>
          <div style={{
            ...
            <Link 
              to={user ? "/CrossSiteScripting/Article" : "/login"}
...
export default CrossSiteScriptingHome;
