...
const levelContent = {
  1: {
    title: "Level 1: Introduction to User Enumeration",
    overview: "Learn the basics of user enumeration attacks and their impact on system security.",
    prerequisites: [
      'Basic understanding of authentication systems',
      'Familiarity with web applications',
      'No prior security knowledge required'
    ]
  },
  2: {
    title: "Level 2: Basic Enumeration Techniques",
    overview: "Explore common user enumeration methods and understand their impact.",
    prerequisites: [
      'Completion of Level 1',
      'Basic networking knowledge',
      'Understanding of login mechanisms'
    ]
  },
  3: {
    title: "Level 3: Advanced Enumeration Methods",
    overview: "Master complex user enumeration techniques and automated tools.",
    prerequisites: [
  ...
  4: {
    ...
    overview: "Learn advanced techniques for detecting and preventing user enumeration attacks.",
    prerequisites: [
  ...
  5: {
    ...
    overview: "Implement enterprise-level protection against user enumeration attacks.",
    prerequisites: [
...
const UserEnumerationHome = () => {
  ...
  const calculateProgress = () => {
    if (!progress?.progress?.userenumeration) return 0;
    const module = progress.progress.userenumeration;
    ...
    if (window.confirm('Are you sure you want to reset your progress? This cannot be undone.')) {
      try {
        const updatedProgress = {
          ...progress.progress,
          userenumeration: Object.fromEntries(
            Object.entries(progress.progress.userenumeration).map(([key]) => [
              key,
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <h1 style={{
            ...
            User Enumeration: Attack & Defense Techniques
          </h1>
          <p style={{
            fontSize: '20px',
            textAlign: 'center',
            ...
            Master user enumeration attacks and defenses through practical labs and real-world scenarios.
          </p>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'sticky', top: '20px' }}>
          <div style={{
            ...
            <Link 
              to={user ? "/UserEnumeration/Article" : "/login"}
...
export default UserEnumerationHome;